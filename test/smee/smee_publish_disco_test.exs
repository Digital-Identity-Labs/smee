defmodule SmeePublishDiscoTest do
  ...
  describe "extract/2" do
    ...
    test "returns appropriate data in the map for this format" do
      assert %{
               ...
               Logos: [
                 %{
                   value: "https://indiid.net/assets/images/logo-compact-tiny.png",
                   width: 16,
                   height: 16,
                   lang: ""
                 },
                 %{
                   value: "https://indiid.net/assets/images/logo-compact-medium.png",
                   width: 80,
                   height: 60,
                   lang: ""
                 }
  ...
  describe "aggregate/2" do
    ...
    test "is valid" do
      ...
      schema =
        File.read!("test/support/schema/disco_schema.json")
        |> Jason.decode!()
  ...
  describe "write_items/2" do
    ...
    test "the files are valid, relatively - officially only an array (aggregate) is valid", %{
      filenames: filenames
    } do
      schema =
        File.read!("test/support/schema/disco_schema.json")
