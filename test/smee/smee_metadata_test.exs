defmodule SmeeMetadataTest do
  ...
  describe "derive/2" do
    ...
    test "size is set automatically to the bytesize of the data" do
      assert %Metadata{size: 39_683} = Metadata.derive(Metadata.entities(@valid_metadata))
    end
    ...
    test "size cannot be set using an option" do
      assert %Metadata{size: 40_658} = Metadata.derive(Metadata.entities(@valid_metadata), size: 100)
    end
